...
- workspace picker, image attachments, multiple concurrent chats, and a workspace-scoped explorer with full-content search, age filters, sorting, and one-click resume for persisted OMP sessions;
